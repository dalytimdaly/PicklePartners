      ...
      <table className={styles.table}>
          <tbody>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{todayfiltered7Court1.length !== 0 ? todayfiltered7Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court2.length !== 0 ? todayfiltered7Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court3.length !== 0 ? todayfiltered7Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court4.length !== 0 ? todayfiltered7Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court5.length !== 0 ? todayfiltered7Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court6.length !== 0 ? todayfiltered7Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court7.length !== 0 ? todayfiltered7Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court8.length !== 0 ? todayfiltered7Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court9.length !== 0 ? todayfiltered7Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered7Court10.length !== 0 ? todayfiltered7Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{todayfiltered8Court1.length !== 0 ? todayfiltered8Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court2.length !== 0 ? todayfiltered8Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court3.length !== 0 ? todayfiltered8Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court4.length !== 0 ? todayfiltered8Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court5.length !== 0 ? todayfiltered8Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court6.length !== 0 ? todayfiltered8Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court7.length !== 0 ? todayfiltered8Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court8.length !== 0 ? todayfiltered8Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court9.length !== 0 ? todayfiltered8Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered8Court10.length !== 0 ? todayfiltered8Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{todayfiltered9Court1.length !== 0 ? todayfiltered9Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court2.length !== 0 ? todayfiltered9Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court3.length !== 0 ? todayfiltered9Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court4.length !== 0 ? todayfiltered9Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court5.length !== 0 ? todayfiltered9Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court6.length !== 0 ? todayfiltered9Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court7.length !== 0 ? todayfiltered9Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court8.length !== 0 ? todayfiltered9Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court9.length !== 0 ? todayfiltered9Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered9Court10.length !== 0 ? todayfiltered9Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{todayfiltered10Court1.length !== 0 ? todayfiltered10Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court2.length !== 0 ? todayfiltered10Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court3.length !== 0 ? todayfiltered10Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court4.length !== 0 ? todayfiltered10Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court5.length !== 0 ? todayfiltered10Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court6.length !== 0 ? todayfiltered10Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court7.length !== 0 ? todayfiltered10Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court8.length !== 0 ? todayfiltered10Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court9.length !== 0 ? todayfiltered10Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered10Court10.length !== 0 ? todayfiltered10Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{todayfiltered11Court1.length !== 0 ? todayfiltered11Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court2.length !== 0 ? todayfiltered11Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court3.length !== 0 ? todayfiltered11Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court4.length !== 0 ? todayfiltered11Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court5.length !== 0 ? todayfiltered11Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court6.length !== 0 ? todayfiltered11Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court7.length !== 0 ? todayfiltered11Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court8.length !== 0 ? todayfiltered11Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court9.length !== 0 ? todayfiltered11Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered11Court10.length !== 0 ? todayfiltered11Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
             </tr> 
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{todayfiltered12Court1.length !== 0 ? todayfiltered12Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court2.length !== 0 ? todayfiltered12Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court3.length !== 0 ? todayfiltered12Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court4.length !== 0 ? todayfiltered12Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court5.length !== 0 ? todayfiltered12Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court6.length !== 0 ? todayfiltered12Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court7.length !== 0 ? todayfiltered12Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court8.length !== 0 ? todayfiltered12Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court9.length !== 0 ? todayfiltered12Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered12Court10.length !== 0 ? todayfiltered12Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{todayfiltered13Court1.length !== 0 ? todayfiltered13Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court2.length !== 0 ? todayfiltered13Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court3.length !== 0 ? todayfiltered13Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court4.length !== 0 ? todayfiltered13Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court5.length !== 0 ? todayfiltered13Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court6.length !== 0 ? todayfiltered13Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court7.length !== 0 ? todayfiltered13Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court8.length !== 0 ? todayfiltered13Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court9.length !== 0 ? todayfiltered13Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{todayfiltered13Court10.length !== 0 ? todayfiltered13Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
