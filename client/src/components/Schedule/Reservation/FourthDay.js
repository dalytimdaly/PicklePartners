      ...
      <table className={styles.table}>
          <tbody>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court1.length !== 0 ? fourthDayfiltered7Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court2.length !== 0 ? fourthDayfiltered7Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court3.length !== 0 ? fourthDayfiltered7Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court4.length !== 0 ? fourthDayfiltered7Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court5.length !== 0 ? fourthDayfiltered7Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court6.length !== 0 ? fourthDayfiltered7Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court7.length !== 0 ? fourthDayfiltered7Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court8.length !== 0 ? fourthDayfiltered7Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court9.length !== 0 ? fourthDayfiltered7Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered7Court10.length !== 0 ? fourthDayfiltered7Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court1.length !== 0 ? fourthDayfiltered8Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court2.length !== 0 ? fourthDayfiltered8Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court3.length !== 0 ? fourthDayfiltered8Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court4.length !== 0 ? fourthDayfiltered8Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court5.length !== 0 ? fourthDayfiltered8Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court6.length !== 0 ? fourthDayfiltered8Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court7.length !== 0 ? fourthDayfiltered8Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court8.length !== 0 ? fourthDayfiltered8Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court9.length !== 0 ? fourthDayfiltered8Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered8Court10.length !== 0 ? fourthDayfiltered8Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court1.length !== 0 ? fourthDayfiltered9Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court2.length !== 0 ? fourthDayfiltered9Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court3.length !== 0 ? fourthDayfiltered9Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court4.length !== 0 ? fourthDayfiltered9Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court5.length !== 0 ? fourthDayfiltered9Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court6.length !== 0 ? fourthDayfiltered9Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court7.length !== 0 ? fourthDayfiltered9Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court8.length !== 0 ? fourthDayfiltered9Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court9.length !== 0 ? fourthDayfiltered9Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered9Court10.length !== 0 ? fourthDayfiltered9Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court1.length !== 0 ? fourthDayfiltered10Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court2.length !== 0 ? fourthDayfiltered10Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court3.length !== 0 ? fourthDayfiltered10Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court4.length !== 0 ? fourthDayfiltered10Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court5.length !== 0 ? fourthDayfiltered10Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court6.length !== 0 ? fourthDayfiltered10Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court7.length !== 0 ? fourthDayfiltered10Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court8.length !== 0 ? fourthDayfiltered10Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court9.length !== 0 ? fourthDayfiltered10Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered10Court10.length !== 0 ? fourthDayfiltered10Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court1.length !== 0 ? fourthDayfiltered11Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court2.length !== 0 ? fourthDayfiltered11Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court3.length !== 0 ? fourthDayfiltered11Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court4.length !== 0 ? fourthDayfiltered11Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court5.length !== 0 ? fourthDayfiltered11Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court6.length !== 0 ? fourthDayfiltered11Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court7.length !== 0 ? fourthDayfiltered11Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court8.length !== 0 ? fourthDayfiltered11Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court9.length !== 0 ? fourthDayfiltered11Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered11Court10.length !== 0 ? fourthDayfiltered11Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
             </tr> 
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court1.length !== 0 ? fourthDayfiltered12Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court2.length !== 0 ? fourthDayfiltered12Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court3.length !== 0 ? fourthDayfiltered12Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court4.length !== 0 ? fourthDayfiltered12Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court5.length !== 0 ? fourthDayfiltered12Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court6.length !== 0 ? fourthDayfiltered12Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court7.length !== 0 ? fourthDayfiltered12Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court8.length !== 0 ? fourthDayfiltered12Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court9.length !== 0 ? fourthDayfiltered12Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered12Court10.length !== 0 ? fourthDayfiltered12Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court1.length !== 0 ? fourthDayfiltered13Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court2.length !== 0 ? fourthDayfiltered13Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court3.length !== 0 ? fourthDayfiltered13Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court4.length !== 0 ? fourthDayfiltered13Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court5.length !== 0 ? fourthDayfiltered13Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court6.length !== 0 ? fourthDayfiltered13Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court7.length !== 0 ? fourthDayfiltered13Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court8.length !== 0 ? fourthDayfiltered13Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court9.length !== 0 ? fourthDayfiltered13Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered13Court10.length !== 0 ? fourthDayfiltered13Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court1.length !== 0 ? fourthDayfiltered15Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court2.length !== 0 ? fourthDayfiltered15Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court3.length !== 0 ? fourthDayfiltered15Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court4.length !== 0 ? fourthDayfiltered15Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court5.length !== 0 ? fourthDayfiltered15Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court6.length !== 0 ? fourthDayfiltered15Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court7.length !== 0 ? fourthDayfiltered15Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court8.length !== 0 ? fourthDayfiltered15Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court9.length !== 0 ? fourthDayfiltered15Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered15Court10.length !== 0 ? fourthDayfiltered15Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court1.length !== 0 ? fourthDayfiltered16Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court2.length !== 0 ? fourthDayfiltered16Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court3.length !== 0 ? fourthDayfiltered16Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court4.length !== 0 ? fourthDayfiltered16Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court5.length !== 0 ? fourthDayfiltered16Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court6.length !== 0 ? fourthDayfiltered16Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court7.length !== 0 ? fourthDayfiltered16Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court8.length !== 0 ? fourthDayfiltered16Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court9.length !== 0 ? fourthDayfiltered16Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered16Court10.length !== 0 ? fourthDayfiltered16Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court1.length !== 0 ? fourthDayfiltered18Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court2.length !== 0 ? fourthDayfiltered18Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court3.length !== 0 ? fourthDayfiltered18Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court4.length !== 0 ? fourthDayfiltered18Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court5.length !== 0 ? fourthDayfiltered18Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court6.length !== 0 ? fourthDayfiltered18Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court7.length !== 0 ? fourthDayfiltered18Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court8.length !== 0 ? fourthDayfiltered18Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court9.length !== 0 ? fourthDayfiltered18Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered18Court10.length !== 0 ? fourthDayfiltered18Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court1.length !== 0 ? fourthDayfiltered20Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court2.length !== 0 ? fourthDayfiltered20Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court3.length !== 0 ? fourthDayfiltered20Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court4.length !== 0 ? fourthDayfiltered20Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court5.length !== 0 ? fourthDayfiltered20Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court6.length !== 0 ? fourthDayfiltered20Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court7.length !== 0 ? fourthDayfiltered20Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court8.length !== 0 ? fourthDayfiltered20Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court9.length !== 0 ? fourthDayfiltered20Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered20Court10.length !== 0 ? fourthDayfiltered20Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
            ...
            <tr className={styles.tableRow}>
              ...
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court1.length !== 0 ? fourthDayfiltered21Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court2.length !== 0 ? fourthDayfiltered21Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court3.length !== 0 ? fourthDayfiltered21Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court4.length !== 0 ? fourthDayfiltered21Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court5.length !== 0 ? fourthDayfiltered21Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court6.length !== 0 ? fourthDayfiltered21Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court7.length !== 0 ? fourthDayfiltered21Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court8.length !== 0 ? fourthDayfiltered21Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court9.length !== 0 ? fourthDayfiltered21Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered21Court10.length !== 0 ? fourthDayfiltered21Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
             </tr> 
            <tr className={styles.tableRow}>
              <td className={styles.tableDateLast}>10PM</td>
              <th className={styles.reservationBlock}>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court1.length !== 0 ? fourthDayfiltered22Court1 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court2.length !== 0 ? fourthDayfiltered22Court2 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court3.length !== 0 ? fourthDayfiltered22Court3 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court4.length !== 0 ? fourthDayfiltered22Court4 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court5.length !== 0 ? fourthDayfiltered22Court5 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court6.length !== 0 ? fourthDayfiltered22Court6 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court7.length !== 0 ? fourthDayfiltered22Court7 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court8.length !== 0 ? fourthDayfiltered22Court8 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court9.length !== 0 ? fourthDayfiltered22Court9 : <Link to='/create'>OPEN</Link>}</div>
                <div className={styles.courtBlock}>{fourthDayfiltered22Court10.length !== 0 ? fourthDayfiltered22Court10 : <Link to='/create'>OPEN</Link>}</div>
                </th>
